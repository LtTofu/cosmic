...
namespace loguru
{
	...
	public:
		...
		~Text();
		Text(Text&& t) noexcept {						/* <-- Warning	C26439:  This kind of function may not throw. Declare it 'noexcept' (f.6).	*/
														/*						 at  line 255	.\LIBS\LOGURU\loguru.hpp  [Cosmic]					*/
			_str = t._str;
			t._str = nullptr;
		}
		Text(Text& t) = delete;
...
#undef MAX
	...
	*/
	...
	{
	public:
		/* loguru\loguru.hpp(593): warning C26495: Variable 'loguru::LogScopeRAII::_start_time_ns' is uninitialized. Always initialize a member variable (type.6). */
		...
		// issue #43
		LogScopeRAII(LogScopeRAII&& other) noexcept		/* warning C26439: This kind of function may not throw. Declare it 'noexcept' (f.6). */
